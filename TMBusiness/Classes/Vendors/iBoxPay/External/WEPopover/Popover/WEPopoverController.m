...
- (void)presentPopoverFromRect:(CGRect)rect 
	...
	contentViewController.view.layer.cornerRadius = 30.f;
...
//	NSLog(@"sub:%@", w.subviews);
    if (w.subviews.count > 2) {
		return [w.subviews objectAtIndex:2];
	} 
    else if (w.subviews.count > 0){
...
- (WEPopoverContainerViewProperties *)defaultContainerViewProperties {
	...
	NSString *bgImageName = @"popoverBgSimple1.png";
	CGFloat bgMargin = 21.0;
