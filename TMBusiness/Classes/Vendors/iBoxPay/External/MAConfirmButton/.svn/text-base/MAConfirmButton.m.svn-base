...
#define kHeight 50.0f //26.0
#define kPadding 175.0
...
- (id)initWithTitle:(NSString *)titleString confirm:(NSString *)confirmString{
    ...
    if(self != nil){
        ...
        [self setTitleColor:[UIColor colorWithWhite:0.31 alpha:1.f] forState:UIControlStateNormal];
        [self setTitleShadowColor:[UIColor colorWithWhite:0.5 alpha:0.5] forState:UIControlStateNormal];
        ...
        ///
        self.tint = [UIColor colorWithWhite:250./255 alpha:1.];
        [self setupLayers];
    }	
    return self;
}
...
- (void)toggle{    
    if(self.userInteractionEnabled){
        ...
        UIColor *greenColor = [UIColor colorWithRed:0.694 green:0.184 blue:0.196 alpha:1];
        ...
        colorAnimation.toValue = selected ? (id)greenColor.CGColor : (id)tint.CGColor;
            UIColor* titleColor = selected ? [UIColor whiteColor] : [UIColor colorWithWhite:0.31 alpha:1.];
...
//    bevelLayer.colors = [NSArray arrayWithObjects:(id)[UIColor colorWithWhite:0 alpha:0.5].CGColor, [UIColor whiteColor].CGColor, nil];
    ...
    bevelLayer.colors = [NSArray arrayWithObjects:(id)[UIColor colorWithWhite:0 alpha:0.5].CGColor, [UIColor colorWithWhite:0.7 alpha:1.].CGColor, nil];
    ...
    colorLayer.borderColor = [UIColor colorWithWhite:0.1 alpha:0.1].CGColor;
